...
public class StaffHeal1 extends Item {

	public StaffHeal1() {
		super(new Item.Properties().group(ITEM_GROUP).maxDamage(4));
	}
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand handIn) {
		...
		if (!worldIn.isRemote) {
			if (playerIn.getHealth() < playerIn.getMaxHealth()) {
				playerIn.addPotionEffect(new EffectInstance(Effects.INSTANT_HEALTH,	1, 0, false, false));
