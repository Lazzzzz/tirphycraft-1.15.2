...
public class StaffExplosion3 extends Item {

	public StaffExplosion3() {
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand handIn) {
		...
		if (!worldIn.isRemote) {
			...
			TNTEntity tnt3 = new TNTEntity(worldIn, x, y, z, playerIn);
			tnt3.setMotion(aim.x * 1D, aim.y * 0.5D, aim.z * 1D);
			worldIn.addEntity(tnt3);
