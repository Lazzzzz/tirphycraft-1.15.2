...
public class DragonFlyModel extends EntityModel<EntityDragonFly> {
	...
	@Override
	public void setRotationAngles(EntityDragonFly entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
        this.HEAD.rotateAngleX = headPitch * ((float)Math.PI / 180F);
        this.HEAD.rotateAngleY = netHeadYaw * ((float)Math.PI / 180F);
        this.right_back.rotateAngleZ = MathHelper.cos(ageInTicks) * 0.4F;
        this.left_top_1.rotateAngleZ = MathHelper.cos(ageInTicks) * 0.4F;
        this.left_back.rotateAngleZ = -MathHelper.cos(ageInTicks) * 0.4F;
        this.left_top.rotateAngleZ = -MathHelper.cos(ageInTicks) * 0.4F;
	}
