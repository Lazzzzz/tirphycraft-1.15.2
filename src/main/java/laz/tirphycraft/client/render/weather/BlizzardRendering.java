			...
			for (int j1 = k - l; j1 <= k + l; ++j1) {
				for (int k1 = i - l; k1 <= i + l; ++k1) {
					...
					if (biome.getPrecipitation() != Biome.RainType.NONE) {
						int i2 = world.getHeight(Heightmap.Type.MOTION_BLOCKING, blockpos$mutableblockpos).getY();
						int j2 = j - l;
						int k2 = j + l;
						if (j2 < i2) {
							j2 = i2;
						...
						if (j2 != k2) {
							...
							if (f2 >= 0.15F) {
								...
								int i3 = this.rendererUpdateCount + k1 * k1 * 3121 + k1 * 45238971 + j1 * j1 * 418711
										+ j1 * 13761 & 31;
