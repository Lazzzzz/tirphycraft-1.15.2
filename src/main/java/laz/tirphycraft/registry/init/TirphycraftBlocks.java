...
import static laz.tirphycraft.registry.TirphycraftRegistries.addBlockClass;
import static laz.tirphycraft.registry.TirphycraftRegistries.addCubedBlock;
import static laz.tirphycraft.registry.TirphycraftRegistries.addOnlyBlockClass;
import static laz.tirphycraft.registry.TirphycraftRegistries.addTileEntity;
...
public static BlockRegistryObjectGroup<Block, BlockItem, ?> NOXIS_FIRE;//
...
public static void init(){
       ...
       NOXIS_FIRE    = addBlockClass("noxis_fire_thrower", () -> new NoxisFireBlock());
       ...
       FROZ_TELEPORTER = addOnlyBlockClass("froz_portal", TeleporterFrozBlock::new);
       __FROZ_TELEPORTER = addOnlyBlockClass("froz_portal_null", __TeleporterFrozBlock::new);
       
       LAPUTA_TELEPORTER = addOnlyBlockClass("laputa_portal", TeleporterLaputaBlock::new);
       __LAPUTA_TELEPORTER = addOnlyBlockClass("laputa_portal_null", __TeleporterLaputaBlock::new);
       ...
       FROZ_DUNGEON_VARIANT3 = addOnlyBlockClass("froz_dungeon_v3", FrozDungeonBricks::new);
       FROZ_DUNGEON_VARIANT4 = addOnlyBlockClass("froz_dungeon_v4", FrozDungeonBricks::new);
       FROZ_DUNGEON_VARIANT5 = addOnlyBlockClass("froz_dungeon_v5", FrozDungeonBricks::new);
       FROZ_DUNGEON_VARIANT6 = addOnlyBlockClass("froz_dungeon_v6", FrozDungeonBricks::new);
       FROZ_DUNGEON_VARIANT7 = addOnlyBlockClass("froz_dungeon_v7", FrozDungeonBricks::new);
       FROZ_DUNGEON_VARIANT8 = addOnlyBlockClass("froz_dungeon_v8", FrozDungeonBricks::new);
