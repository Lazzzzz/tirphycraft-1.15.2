...
public class SacredBiomeProvider extends BiomeProvider {

	public static Biome[] dimensionBiomes = new Biome[] {
			ForgeRegistries.BIOMES.getValue(new ResourceLocation(Tirphycraft.MOD_ID + ":sg_plains")) };

	private static final Set<Biome> biomeList = ImmutableSet.of(TirphycraftBiomes.SG_PLAINS.get());

	private final Layer genBiomes;
	private final Biome[] biomes;

	public SacredBiomeProvider(World world) {
		super(biomeList);
