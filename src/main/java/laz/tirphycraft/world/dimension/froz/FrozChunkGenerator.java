...
public class FrozChunkGenerator extends NoiseChunkGenerator<FrozGenSettings> {
	...
	public FrozChunkGenerator(IWorld worldIn, BiomeProvider provider, FrozGenSettings settingsIn) {
