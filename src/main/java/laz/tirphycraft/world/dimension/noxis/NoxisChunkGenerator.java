...
public class NoxisChunkGenerator extends NoiseChunkGenerator<NoxisGenSettings> {
	...
	public NoxisChunkGenerator(IWorld worldIn, BiomeProvider provider, NoxisGenSettings settingsIn) {
