...
public class LaputaChunkGenerator extends NoiseChunkGenerator<LaputaGenSettings> {
	...
	public LaputaChunkGenerator(IWorld worldIn, BiomeProvider provider, LaputaGenSettings settingsIn) {
