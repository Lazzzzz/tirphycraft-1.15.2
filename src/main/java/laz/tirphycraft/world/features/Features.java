...
import laz.tirphycraft.world.features.noxis.LaputaTeleporterFeature;
...
public class Features {
	...
	public static ConfiguredFeature<NoFeatureConfig, ?> NIXIUM			= new OreDepositFeatures(TirphycraftBlocks.FROZ_STONE.get().getDefaultState(), TirphycraftBlocks.ORE_NIXIUM.get().getDefaultState(), 0, 10, 3, 35, NoFeatureConfig::deserialize).withConfiguration(IFeatureConfig.NO_FEATURE_CONFIG);
	public static ConfiguredFeature<NoFeatureConfig, ?> HISTICE_ICE		= new OreDepositFeatures(TirphycraftBlocks.FROZ_STONE.get().getDefaultState(), TirphycraftBlocks.ORE_HISTICE_ICE.get().getDefaultState(), 30, 48, 1, 10, NoFeatureConfig::deserialize).withConfiguration(IFeatureConfig.NO_FEATURE_CONFIG);
	public static ConfiguredFeature<NoFeatureConfig, ?> PICITE			= new OreDepositFeatures(TirphycraftBlocks.FROZ_STONE.get().getDefaultState(), TirphycraftBlocks.ORE_PICITE.get().getDefaultState(), 10, 48, 5, 10, NoFeatureConfig::deserialize).withConfiguration(IFeatureConfig.NO_FEATURE_CONFIG);
	public static ConfiguredFeature<NoFeatureConfig, ?> TENIUM			= new OreDepositFeatures(TirphycraftBlocks.LAPUTA_STONE.get().getDefaultState(), TirphycraftBlocks.ORE_TENIUM.get().getDefaultState(), 10, 48, 3, 35, NoFeatureConfig::deserialize).withConfiguration(IFeatureConfig.NO_FEATURE_CONFIG);
	...
	public static ConfiguredFeature<NoFeatureConfig, ?> SNOW_TRAP			= new SnowTrapFeature(NoFeatureConfig::deserialize).withConfiguration(IFeatureConfig.NO_FEATURE_CONFIG);
