...
public class Features {
	...
	public static ConfiguredFeature<NoFeatureConfig, ?> PICITE			= new OreDepositFeatures(TirphycraftBlocks.FROZ_STONE.get().getDefaultState(), TirphycraftBlocks.ORE_PICITE.get().getDefaultState(), 10, 48, 5, 3, NoFeatureConfig::deserialize).withConfiguration(IFeatureConfig.NO_FEATURE_CONFIG);
