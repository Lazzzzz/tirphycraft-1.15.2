...
public class Features {
	...
	public static ConfiguredFeature<NoFeatureConfig, ?> HISTOIRE_ICE	= new OreDepositFeatures(TirphycraftBlocks.FROZ_STONE.get().getDefaultState(), TirphycraftBlocks.HISTOIRE_ICE.get().getDefaultState(), 10, 48, 1, 10, NoFeatureConfig::deserialize).withConfiguration(IFeatureConfig.NO_FEATURE_CONFIG);
